...
INTENT_PHRASES: list[tuple[str, list[str]]] = [
    (
        "kill",
        ["get rid of", "shut down", "turn off", "stop the process", "kill whatever is"],
    ),
    ...
    (
        "compress",
        ["make a zip", "create an archive", "bundle up", "compress these files"],
    ),
    ...
    (
        "network",
        ["whats using port", "who is using port", "what is on port", "network port"],
    ),
